...
class RoomControllerTest {
    ...
    void availabilityReturns200WithExternallyAvailableRooms() throws Exception {
        ...
        room.setId(1L);
        room.setName("Room 1");
        when(roomAvailabilityService.availableRoomsOn(any(OffsetDateTime.class))).thenReturn(List.of(room));

        mockMvc.perform(get("/api/rooms/availability?date=2026-08-20T00:00:00Z"))
    ...
    void availabilityReturns503WhenExternalCheckFails() throws Exception {
        when(roomAvailabilityService.availableRoomsOn(any(OffsetDateTime.class)))
